...
var syd_score_i = echarts.init(document.getElementById('sydney-i'));
syd_score_i.showLoading();
$.getJSON('../data/all_senti_analysis.json', function (jsondata) {
    console.log(JSON.stringify(jsondata));
    syd_score_i.hideLoading()
    var index = "1"
    var syd_score_i_option = {
        title: {
    ...
    syd_score_i.setOption(syd_score_i_option);
});