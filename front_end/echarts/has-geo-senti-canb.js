...
var canb_score_g = echarts.init(document.getElementById('canberra-g'));
canb_score_g.showLoading();
$.getJSON('../data/has_geo_senti_analysis.json', function (jsondata) {
    console.log(JSON.stringify(jsondata));
    canb_score_g.hideLoading()
    var index = "3"
    var canb_score_g_option = {
        title: {
    ...
    canb_score_g.setOption(canb_score_g_option);
});