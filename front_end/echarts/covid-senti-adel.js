...
var adel_score_c = echarts.init(document.getElementById('adelaide-c'));
adel_score_c.showLoading();
$.getJSON('../data/covid_senti_analysis.json', function (jsondata) {
    console.log(JSON.stringify(jsondata));
    adel_score_c.hideLoading()
    var index = "3"
    var adel_score_c_option = {
        title: {
    ...
    adel_score_c.setOption(adel_score_c_option);
});